...
$query = "SELECT e.type_of_leave , p.emp_first_name , p.emp_last_name FROM emp_leaves e , pds p where e.emp_id = p.emp_id and month(e.leave_from_date) = '$month' and year(e.leave_from_date) = '$year'" ;//CURDATE()
