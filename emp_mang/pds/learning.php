                ...
                <div class="form-group mx-sm-1 mb-2">
                    <div class="d-flex flex-column">
                        <label for="">INCLUSIVE DATES</label>
                            ...
                            <input type="date" class="form-control mx-sm-1 mb-2"  style="width:140px;" value="<?php echo $from_date?>" name="from_date" >
                            
                            <input type="date" class="form-control mx-sm-1 mb-2"  style="width:140px;" value="<?php echo $to_date?>" name="to_date" >
