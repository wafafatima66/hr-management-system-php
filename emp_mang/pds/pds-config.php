...
if(isset($_POST['submit'])){
   ...
   /* $emp_tel_no=$_POST['emp_tel_no'];
    ...
    require '../../includes/conn.php';
            ...
            $sql="INSERT INTO pds (emp_gender,emp_civil_status,emp_dob,emp_height,emp_weight,emp_blood,emp_citizen,emp_resi_add,emp_per_add,emp_contact) VALUE (?,?,?,?,?,?,?,?,?,?)";
            ...
            if(!mysqli_stmt_prepare($stmt,$sql)){
                ...
                exit();
                    ...
                    mysqli_stmt_bind_param($stmt,"sssiisssss", $emp_gender, $emp_civil_status, $emp_dob,$emp_height,$emp_weight,$emp_blood,$emp_citizen,$emp_resi_add,$emp_per_add,$emp_contact);
