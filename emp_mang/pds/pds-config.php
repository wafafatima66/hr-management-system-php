...
if(isset($_POST['submit'])){
    ...
    $emp_resi_per_title=$_POST['emp_resi_per'];
    $emp_resi_per_street=$_POST['emp_resi_per_street'];
    $emp_resi_per_subdivision=$_POST['emp_resi_per_subdivision'];
    $emp_resi_per_barangay=$_POST['emp_resi_per_barangay'];
    $emp_resi_per_municipal=$_POST['emp_resi_per_municipal'];
    $emp_resi_per_province=$_POST['emp_resi_per_province'];
    $emp_resi_per_zipcode=$_POST['emp_resi_per_zipcode'];
   ...
   // $emp_contact=$_POST["emp_tel_no,emp_mb_no,emp_email,emp_contact_gs,emp_contact_pag,emp_contact_ph,emp_contact_ss,emp_contact_tin,emp_contact_agency"];
    ...
    $emp_citizen_arr = array("$emp_citizen_title " , "$emp_citizen_chk ","$emp_dual_citizen"); // Declare an array
   ...
   $emp_resi_add_arr = array("$emp_resi_add_title " , "$emp_resi_add_street ", "$emp_resi_add_subdivision ","$emp_resi_add_barangay ","$emp_resi_add_municipal ","$emp_resi_add_province ","$emp_resi_add_zipcode ",); // Declare an array
   $emp_resi_add = implode(',',$emp_resi_add_arr);

    
   $emp_resi_per_arr = array("$emp_resi_per_title " , "$emp_resi_per_street ", "$emp_resi_per_subdivision ","$emp_resi_per_barangay ","$emp_resi_per_municipal ","$emp_resi_per_province ","$emp_resi_per_zipcode ",); // Declare an array
   $emp_per_add = implode(',',$emp_resi_per_arr);

    
    require '../../includes/conn.php';


            $sql="INSERT INTO pds (emp_gender,emp_civil_status,emp_dob,emp_height,emp_weight,emp_blood,emp_citizen,emp_resi_add,emp_per_add,emp_contact,emp_id,emp_first_name,emp_last_name,emp_email) VALUE (?,?,?,?,?,?,?,?,?,?,?,?,?,?)
            ...
            if(!mysqli_stmt_prepare($stmt,$sql)){
                ...
                exit();
                    ...
                    mysqli_stmt_bind_param($stmt,"sssiisssssisss",$emp_gender, $emp_civil_status, $emp_dob,$emp_height,$emp_weight,$emp_blood,$emp_citizen,$emp_resi_add,$emp_per_add,$insertValue,$emp_id,$emp_first_name,$emp_last_name,$emp_email);
