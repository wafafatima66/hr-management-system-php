        ...
        <?php 
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <div class="d-flex flex-column">
                        <label for="">NAME OF ORGANISATION</label>
                        <input type="text" class="form-control" style="width:200px;" name="name_org[]">
                    </div>
                </div>
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <div class="d-flex flex-column">
                        <label for="">ADDRESS</label>
                        <input type="text" class="form-control"  style="width:200px;" name="org_add[]">
                    </div>
                </div>
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <div class="d-flex flex-column">
                        <label for="">INCLUSIVE DATES</label>
                            ...
                            <input type="date" class="form-control mx-sm-1" name="vol_from_date[]">

                            <input type="date" class="form-control mx-sm-1" name="vol_to_date[]">
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-center">
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <label for="">NO OF HOURS</label>
                        <input type="text" class="form-control"   style="width:100px;" name="vol_no_of_hrs[]">    
                    </div>

                    <div class="form-group mx-sm-3 mb-2">
                        <label for="">POSITION/ROLE</label>
                        <input type="text" class="form-control"   style="width:120px;" name="position[]">    
                    </div>
