            ...
            <form method="post" action="pds/civil-config.php" class="form-inline">
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" class="form-control" id="" placeholder="" name ="name_of_exam">
                        </div>
                    </div>
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" class="form-control" id="" placeholder="" name="rating">
                        </div>
                    </div>
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" class="form-control" id="" placeholder="" name="exam_date">
                        </div>
                    </div>
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" class="form-control" id="" placeholder="" name="exam_place">
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" class="form-control" id="" placeholder="" name="licence_no">
                        </div>
                    </div>
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" class="form-control" id="" placeholder="" name="licence_val">
                        </div>
                    </div>
