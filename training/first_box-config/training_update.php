...
$query = "UPDATE training SET type_of_training= '$type_of_training',  from_date= '$from_date' , to_date= '$to_date' , no_of_hrs= '$no_of_hrs' , venue= '$venue' , province= '$province'  , agency= '$agency'   where title_of_training = '$title_of_training' and emp_id =$emp_id";
